...
UBUNTU_TRANSLATION_DOMAIN="pagestacktest1.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pagestacktest1/tests/autopilot/run
aptest.depends  = sub-pagestacktest1

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pagestacktest1/tests/unit 
unittest.depends  = sub-pagestacktest1
